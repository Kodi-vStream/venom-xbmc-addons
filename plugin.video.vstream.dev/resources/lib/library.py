...
class cLibrary:
    ...
    def __init__(self):
        ...
        if not self.__sMovieFolder:
            ...
            self.__sMovieFolder = "special://userdata/addon_data/plugin.video.vstream.dev/Films"
        ...
        if not self.__sTVFolder:
            ...
            self.__sTVFolder = "special://userdata/addon_data/plugin.video.vstream.dev/Series"
    ...
    def setLibrary(self):
        ...
        sLink = 'plugin://plugin.video.vstream.dev/?function=play&site=cHosterGui&sFileName=' + sFileName + '&sMediaUrl=' + sMediaUrl + '&sHosterIdentifier=' + sHosterIdentifier
    ...
    def getLibrary(self):
        xbmc.executebuiltin("Container.Update(special://userdata/addon_data/plugin.video.vstream.dev/)", True)
        #xbmc.executebuiltin('ActivateWindow(Videos,"special://userdata/addon_data/plugin.video.vstream.dev/")', True)
        return True
