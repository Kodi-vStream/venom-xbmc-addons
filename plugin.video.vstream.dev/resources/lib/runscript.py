...
#vstream = xbmcaddon.Addon('plugin.video.vstream.dev')
...
class cClear:
    ...
    def main(self, env):
        ...
        if (env == 'urlresolver'):
            ...
            try:
                sUrl = 'https://raw.githubusercontent.com/Kodi-vStream/venom-xbmc-addons/master/plugin.video.vstream.dev/changelog.txt'
            ...
            try:
                sUrl = 'https://raw.githubusercontent.com/Kodi-vStream/venom-xbmc-addons/master/plugin.video.vstream.dev/soutient.txt'
                oRequest =  urllib2.Request(sUrl)
                oResponse = urllib2.urlopen(oRequest)
                sContent = oResponse.read()
            ...
            if self.DIALOG.VSyesno("Êtes-vous sûr?"):
                ...
                cached_Cache = "special://home/userdata/addon_data/plugin.video.vstream.dev/video_cache.db"
            ...
            cached_DB = "special://home/userdata/addon_data/plugin.video.vstream.dev/vstream.db"
            ...
            class XMLDialog(xbmcgui.WindowXMLDialog):
                ...
                def onInit(self):
                    ...
                    for aPlugin in aPlugins:
                        ...
                        icon = "special://home/addons/plugin.video.vstream.dev/resources/art/sites/%s.png" % aPlugin[1]
            ...
            DB = "special://home/userdata/addon_data/plugin.video.vstream.dev/vstream.db"
            if select >= 0:
