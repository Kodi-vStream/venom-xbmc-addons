...
class cDownload:
    ...
    def download(self, sDBUrl, sTitle,sDownloadPath,FastMode = False):
        ...
        #aLink = (True,'https://github.com/LordVenom/venom-xbmc-addons-beta/blob/master/plugin.video.vstream.dev/Thumbs.db?raw=true')
    ...
    def getDownload(self):
        ...
        item = xbmcgui.ListItem('Demarrer la liste', iconImage='special://home/addons/plugin.video.vstream.dev/resources/art/download.png')
