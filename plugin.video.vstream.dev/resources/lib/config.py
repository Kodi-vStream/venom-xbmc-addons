...
class GestionCookie():
    #PathCache = xbmc.translatePath(xbmcaddon.Addon('plugin.video.vstream.dev').getAddonInfo("profile")).decode("utf-8")
    PathCache = "special://userdata/addon_data/plugin.video.vstream.dev"
...
def WindowsBoxes(sTitle, sFileName, num,year = ''):
    ...
    #path = xbmc.translatePath("special://home/addons/plugin.video.vstream.dev").decode("utf-8")
