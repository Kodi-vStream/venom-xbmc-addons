...
class cGuiElement:
    ...
    def __init__(self):
        ...
        self.__sRootArt = 'special://home/addons/plugin.video.vstream.dev/resources/art/'
        self.__sType = 'Video'
        self.__sMeta = 0
        self.__sPlaycount = 0
        self.__sTrailerUrl = ''
        ...
        self.__sFanart = "special://home/addons/plugin.video.vstream.dev/fanart.jpg"
...
#        self.__sTitleWatched = sTitleWatched
    ...
    def getIcon(self):
        ...
        folder = "special://home/addons/plugin.video.vstream.dev/resources/art"
