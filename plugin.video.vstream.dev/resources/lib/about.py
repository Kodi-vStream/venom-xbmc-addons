...
#sLibrary = xbmc.translatePath("special://home/addons/plugin.video.vstream.dev").decode("utf-8")
...
class cAbout:
    ...
    def getRootPath_old(self, folder):
        sMath = cConfig().getAddonPath().replace('plugin.video.vstream.dev', '').decode("utf-8")
        ...
        if dialogs.VSyesno("Êtes-vous sûr?"):
            ...
            if result:
                ...
                for i in result['files']:
                    ...
                    if 'plugin.video.vstream.dev' in i['filename']:
                ...
                icon = "special://home/addons/plugin.video.vstream.dev/resources/art/update.png"
