...
tlastvf = '#lastvf'          #  Derniers episodes vf Ajouté # episode pas de desc normal
...
def showGenres():
    ...
    # '-0' valide first request : RequestHandlerGenre =>'-1'for next page
...
def showSaisons():
    ...
    sPattern = 'fsynopsis.+?<p>([^<]*)<.p>'  # opsis"><p><p> parfois
    aResult = oParser.parse(sHtmlContent, sPattern)
    if aResult[0]:
