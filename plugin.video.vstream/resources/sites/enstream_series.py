...
def showGenres():
    ...
    # liste.append(['Comédie Musicale', URL_MAIN + 'series/comedie-musical/'])
    ...
    # liste.append(['Péplum', URL_MAIN + 'series/peplum/'])
...
def showSeries(sSearch=''):
    ...
    if (aResult[0] == True):
        ...
        for aEntry in aResult[1]:
            ...
            oGui.addMovie(SITE_IDENTIFIER, 'showSaisons', sTitle, '', sThumb, '', oOutputParameterHandler)
