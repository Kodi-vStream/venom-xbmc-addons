...
def load():
    ...
    oGui.addDir(SITE_IDENTIFIER, MOVIE_ANNEES[1], 'Films (Par Années)', 'films_annnes.png', oOutputParameterHandler)
...
def showMovies(sSearch = ''):
    ...
    if (aResult[0] == True):
        ...
        for aEntry in aResult[1]:
            ...
            oGui.addMovie(SITE_IDENTIFIER, 'showLinks', sTitle, '', sThumb, sResume, oOutputParameterHandler)
...
def showLinks():
    ...
    if (aResult[0] == True):
        ...
        for aEntry in aResult[1]:
            ...
            sTitle = sMovieTitle + ' [' + str(aEntry[2]) + '/' + str(aEntry[3]) + '] ' + '[COLOR skyblue]' + str(aEntry[1]) + '[/COLOR]'
            sUrl = str(aEntry[0])
