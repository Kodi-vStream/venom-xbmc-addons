...
def showGenres():
    ...
    liste.append( ['Action & Adventure', URL_MAIN + 'category/action-adventure/'] )
    ...
    liste.append( ['Science Fiction & Fantastique', URL_MAIN + 'category/science-fiction-fantastique/'] )
