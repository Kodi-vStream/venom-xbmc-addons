...
MOVIE_NEWS = ('http://streaming-kids.com/film-animation-en-streaming', 'showMovies')
...
def showMovies(sSearch = ''):
    ...
    if (aResult[0] == True):
        ...
        for aEntry in aResult[1]:
            ...
            sTitle = aEntry[1]
            oOutputParameterHandler = cOutputParameterHandler()
            oOutputParameterHandler.addParameter('siteUrl', 'http://streaming-kids.com/film-streaming/'+aEntry[1])
