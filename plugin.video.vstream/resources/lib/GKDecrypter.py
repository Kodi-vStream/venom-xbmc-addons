...
class GKDecrypter:
    def __init__(self, param1, param2):
        ...
        self.Rcon = [1, 2, 4, 8, 16, 32, 64, 128, 27, 54, 108, 216, 171, 77, 154,
    ...
    def keyExpansion(self, param1):
        ...
        while _loc4_ < self.Nk:
            if (_loc4_) < len(param1) / 4:
                _loc3_[_loc4_] = param1[4 * _loc4_] | param1[4 * _loc4_ + \
                    1] << 8 | param1[4 * _loc4_ + 2] << 16 | param1[4 * _loc4_ + 3] << 24
            _loc4_ += 1
        _loc4_ = self.Nk
    ...
    def mixColumn(self, param1, param2):
        ...
        while (_loc5_ < self.Nb):
            ...
            while (_loc4_ < 4):
                ...
                if (param2 == "encrypt"):
                    _loc3_[_loc4_] = self.mult_GF256(param1[_loc4_][_loc5_], 2) ^ self.mult_GF256(
                        param1[(_loc4_ + 1) % 4][_loc5_], 3) ^ param1[(_loc4_ + 2) % 4][_loc5_] ^ param1[(_loc4_ + 3) % 4][_loc5_]
                else:
