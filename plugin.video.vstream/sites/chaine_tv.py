...
def load():
    ...
    liste.append( ['D8','http://hls1.maiyo-tv.com/index.m3u8?c=fr_d8'] )
    ...
    liste.append( ['BfmTV','http://bfmlive2-i.akamaihd.net/hls/live/214427/bfmtv/04.m3u8'] ) 
    ...
    liste.append( ['LCP','http://http5.iphone.yacast.net/iphone/lcp/lcptnt/lcptnt_iphone.m3u8'] )
    ...
    for sTitle,sUrl in liste:
        ...
        __createMenuEntry(oGui, 'play', sTitle, 'tv.png', '', '', 0, oOutputParameterHandler)
